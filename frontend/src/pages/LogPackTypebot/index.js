...
const VersionLog = () => {
    ...
    useEffect(() => {
        const fetchReadme = async () => {
            try {
                const response = await axios.get("https://api.github.com/repos/alexsander19/logs/contents/README.md");
    ...
    return (
        ...
        >
            <h2 style={{ textAlign: "center", color: "#333", marginBottom: "20px", fontSize: "18px" }}>
                Log de Versões
            </h2>
